...
<body class="is-preload" ng-app="staffType">
								...
								<section>
									...
									<article>	
										<form action="" method="post">
											<strong>Staff Band</strong>	
											<input type="text" ng-model="staffBand" required="required"/>
											<input type="hidden" ng-model="id" required="required"/>
											<strong>Description</strong>	
											<input type="text" ng-model="bandDesc" required="required"/>
										
										<br>
										
										<input type="button" ng-click="addStaffBand()" value="Save">
		...
		<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}/resources/js/angular/controller/staffBand.js"></script>
