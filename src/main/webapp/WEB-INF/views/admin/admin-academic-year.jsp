...
<body class="is-preload" ng-app="academicYear">
		<!-- Wrapper -->
			<div id="wrapper"  ng-controller="academicYearController">
				<!-- Main -->
					<div id="main">
								...
								<section>
									...
									<article>	
										<form action="" method="post">
											...
											<input type="text" ng-model="academicYear" required="required"/>
											<input type="hidden" ng-model="id" required="required"/>
										<br>
										
										<input type="button" ng-click="addAcademicYear()" value="Save">
		...
		<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}/resources/js/angular/controller/academicYear.js"></script>
