...
<body class="is-preload" ng-app="subjects">
		<!-- Wrapper -->
			<div id="wrapper"  ng-controller="subjectsController">
				<!-- Main -->
					<div id="main">
						<div class="inner">
								...
								<section>
									...
									<article>	
										<form action="" method="post">
											...
											<input type="text" ng-model="subjectName" required="required"/>
											<input type="hidden" ng-model="id" required="required"/>
										<br>
										
										<input type="button" ng-click="addSubject()" value="Save">
		...
		<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}/resources/js/angular/controller/subjects.js"></script>
